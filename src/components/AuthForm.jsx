...
//                   role === 'user' ? 'bg-purple-600 text-white' : 'bg-white/10 text-white border-white/30'
//                 }`}
//               >
//                 User
//               </button>
...
//                 className={`px-4 py-1 rounded-full border transition ${
//                   role === 'seller' ? 'bg-purple-600 text-white' : 'bg-white/10 text-white border-white/30'
//                 }`}
//               >
//                 Seller
//               </button>
...
const AuthForm = ({ type = 'login' }) => {
  ...
  const [checkingToken, setCheckingToken] = useState(true); // token verification status
  ...
  // Auto-verify token from localStorage on load
  useEffect(() => {
