...
//     return (
//       <div className="text-white text-center mt-20">No books available.</div>
//     );
//   }
...
//             className="bg-white/10 rounded-2xl p-6 backdrop-blur-md shadow-lg transition-transform transform hover:scale-105"
...
//             <button
//               className="mt-4 text-sm text-purple-300 underline hover:text-purple-400 cursor-pointer"
//               onClick={() =>
//                 navigate('/add-book', {
//                   state: {
//                     book: {
...
//             </button>
//             <button
//               className="mt-2 text-sm text-blue-300 underline hover:text-blue-400 cursor-pointer"
//               onClick={() => navigate(`/book/${book.book_id}/sellers`, { state: { title: book.title } })}
//             >
//               🔍 View All Sellers
//             </button>
